...
async def save(client: Client, message: Message):
    if "https://t.me/" in message.text:
        ...
        for msgid in range(fromID, toID + 1):
            ...
            # Check if this is not the last file in batch before adding delay
            if msgid < toID:
                # Add 30-second delay after upload completion
...
async def handle_private(client: Client, acc, message: Message, chatid: int, msgid: int):
    ...
    # Note: The 30-second delay is now handled in the save() function after handle_private() completes
